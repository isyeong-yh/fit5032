                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="form-check">
                                ...
                                <input type="checkbox" class="form-check-input" id="isAustralian" 
                                    @blur="() => validateResidency(true)"
                                    @input="() => validateResidency(false)"
...
<script setup>
    ...
    const validateResidency = (blur) => {
        if (!formData.value.isAustralian) {
            if (blur) errors.value.isAustralian = "Please check your residency.";
        } else {
    ...
    const validateReason = (blur) => {
        if (formData.value.reason.length < 1) {
            if (blur) errors.value.reason = "Please indicate a reason for joining.";
        } else {
